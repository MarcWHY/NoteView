...
$sources = @('MusicTheory.cs','KeySignature.cs','StaffView.cs', 'LayoutBoard.cs','AppSettings.cs','ObsFrameRenderer.cs','ObsFrameWorker.cs') | ForEach-Object { Join-Path $projectRoot ('src\' + $_) }
