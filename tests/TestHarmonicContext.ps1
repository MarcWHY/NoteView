...
& (Join-Path $framework 'csc.exe') /nologo /target:exe /platform:x64 /codepage:65001 /main:NoteView.HarmonicContextTests ('/out:' + $testExe) @references @sources (Join-Path $PSScriptRoot 'HarmonicContextTests.cs')
